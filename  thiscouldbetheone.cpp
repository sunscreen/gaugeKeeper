...
uint8_t ret = ESP_FAIL;
  ...
  for (int8_t x=0;x < sizeof(VALIDCAN);x++) {
    uint8_t chkarbid=VALIDCAN[x].ARBID;
    if (chkarbid == mARBID) ret=ESP_OK;
...
byte chksum_map_329[] = {0x84,0xDF,0x11,0x40};
...
//    Data: 0x0D 0x00 0x00 0x00 0x56 0x34 0x00 0x00
    ...
    sendARBID(0x545,0xA0,fuelbyte1,fuelbyte2,b3,0x94,0x00,0x00,0x00);
